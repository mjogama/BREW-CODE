...
export const validatePaginatedOrders = asyncErrorHandler(async (req, res, next) => {
...
export const validateUpdateOrderStatusById = asyncErrorHandler(async (req, res, next) => {
