...
import { validateNewOrder, validateTotalCustomersOrder, validateTotalRevenue, validateUpdateOrderStatusById, validateDeleteOrder } from "../middlewares/schemaValidators/orderValidator.js";
...
router.get("/analytics-data", authToken, orderController.productsSold);
